...
[[ ! -f /config/.config/qBittorrent/qBittorrent.conf ]] && cp /etc/qBittorrent.conf /config/.config/qBittorrent/
...
su qbittorrent --session-command "qbittorrent-nox --webui-port=$WEIUI_PORT"
